Java.perform(function x() {
    ...
    BaseWidgetBean["changeValues"].overload("java.lang.String","java.lang.String","java.lang.String","boolean","boolean","com.lumiunited.aqara.application.utils.h","boolean").implementation = function (p1,p2,p3,p4,p5,p6,p7) {
        ...
        // Aqara LED Bulb
        if(p2=="4.1.85") {
            let val_ = getActionValue("Aqara", device_id, "switch", "switch");
            if(val_){
                if(val_=="True"){
                    val_ = "1";
                }
        ...
        if(p2=="14.1.85") {
            let val_ = getActionValue("Aqara", device_id, "brightness", "brightness");
            if(val_){
                // console.log("new val_ is " + val_);
                p3 = val_;
            }
        ...
        if(p2=="14.2.85") {
            let val_ = getActionValue("Aqara", device_id, "colortemperature", "colortemperature");
            if(val_){
                // console.log("new val_ is " + val_);
                p3 = (Number(val_)+154)+"";
            }
